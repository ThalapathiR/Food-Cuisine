...
import venuzula from "../venezula/venezula.json";
import "bootstrap/dist/css/bootstrap.min.css";
import { Modal, Button, Card, Form } from "react-bootstrap";

export const Venezula = () => {
  ...
  useEffect(() => {
    try {
      setCuisines(venuzula.Venezula_Cuisine);
      setLoading(false);
    } catch (error) {
  ...
  const validateForm = () => {
    ...
    if (!newCuisine.strImage) {
      errors.strImage = "Image is required";
    }
